...
> = {
  ...
  "control-boundary|button#walkNextBtn.btn": { ratio: 1.41, required: 3.0, unverified: false },
  "control-boundary|button#walkWriteBtn.btn": { ratio: 1.41, required: 3.0, unverified: false }
};
